...
// ⚡ Bolt: Extracted to top-level to prevent full unmount/remount cycles on parent render.
const ErrorBanner: React.FC<{
    error: string | null;
    isWritePermissionError: boolean;
    isReplicaIdentityError: boolean;
    onRetry: () => void
}> = React.memo(({ error, isWritePermissionError, isReplicaIdentityError, onRetry }) => {
